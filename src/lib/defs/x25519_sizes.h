...
#define CURVE25519_BASE64_LEN 44
#define CURVE25519_BASE64_BUFSIZE ((CURVE25519_BASE64_LEN)+1)
#define CURVE25519_BASE64_NOPAD_LEN 43
#define CURVE25519_BASE64_NOPAD_BUFSIZE ((CURVE25519_BASE64_NOPAD_LEN)+1)
